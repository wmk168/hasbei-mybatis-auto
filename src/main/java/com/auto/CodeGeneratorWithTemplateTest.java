...
class CodeGeneratorWithTemplateTest {
    ...
    private void generateByTables(String packageName, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://localhost:3306/hasbei_kq?serverTimezone=UTC&useUnicode=true&zeroDateTimeBehavior=convertToNull&characterEncoding=UTF-8&autoReconnect=true&&useSSL=false";
